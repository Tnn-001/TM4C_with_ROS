...
void initQEI0(void)
{
    ...
    QEI0_CTL = 0x00000020;
    QEI0_LOAD = 800000; // This sets the timing window to 1 second when system clock is 16MHz
...
void initQEI1(void)
{
    ...
    QEI1_CTL = 0x00000020;
    QEI1_LOAD = 800000; // This sets the timing window to 1 second when system clock is 16MHz
                         // If you need to sample the speed more quickly then set this to
                         // a smaller value (shorter window) and adjust speed reading accordingly
    QEI1_MAXPOS = 1000;
    QEI1_CTL |= 1;
...
void setMotor1(uint32_t Percent)
{
    if (Percent < 500)
        ...
        Motor1Direction = 1;
    Percent = (Percent * PWM1_PWM2LOAD)/1000;
    PWM1_PWM2CMPA = Percent;
...
void setMotor2(uint32_t Percent)
{
    if (Percent < 500)
        ...
        Motor2Direction = 1;
    Percent = (Percent * PWM1_PWM3LOAD)/1000;
